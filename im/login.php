	...
	?>
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form>
                    <div class="form-group"><label for="email">Teacher Email</label><input class="form-control item" type="email" id="email"></div>
                    ...
                    </div><button class="btn btn-primary btn-block" type="submit"a href="index.php">Log In</button>
                </form>
            </div>
        </section>
    </main>
